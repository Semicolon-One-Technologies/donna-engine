...
import { AlertTriangle, ExternalLink, Menu, RefreshCw } from "lucide-react";
  ...
  return (
    <header className="sticky top-0 z-50 flex items-center justify-between border-b bg-background px-4 py-2">
      <div className="flex items-center gap-3">
        ...
        <Link href="/" className="text-lg font-bold md:hidden">Donna Engine</Link>
      </div>
      <div className="flex items-center gap-3">
        ...
        <Button variant="ghost" size="sm" asChild>
          <a href="https://speaktodonna.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
            <ExternalLink className="h-4 w-4" />
            <span className="hidden sm:inline">Website</span>
          </a>
        </Button>
        <Button variant="outline" size="sm" asChild>
          <a href="https://portal.speaktodonna.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
            <ExternalLink className="h-4 w-4" />
            <span>Portal</span>
          </a>
        </Button>
