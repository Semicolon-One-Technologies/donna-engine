---
title: Setup
description: Set up the Donna contributor environment with the devcontainer-first workflow.
---
<Note>
If the steps below do not work for you, contact Semicolon One Technologies through official support channels.
</Note>
...
- If you cloned the upstream repository directly instead of your fork, see [Fork Workflow](/contribution/fork-workflow) to reset `origin` and `upstream`.
